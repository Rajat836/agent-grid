CREATE TABLE
    IF NOT EXISTS kpis_relationships (
        id BIGSERIAL PRIMARY KEY,
        kpi_id BIGINT NOT NULL,
        relation_type VARCHAR(128) NOT NULL, -- e.g. 'contributes_to', 'depends_on'
        target_type VARCHAR(128) NOT NULL, -- polymorphic: 'service', 'team', 'feature', etc.
        target_id BIGINT NOT NULL,
        weight FLOAT DEFAULT 0,
        weight_set_by VARCHAR(128), -- user/system that set the weight
        weight_reviewed_by VARCHAR(128), -- reviewer identifier
